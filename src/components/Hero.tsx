...
import { ArrowRight, CheckCircle2, PhoneCall, Award, Factory, PackageCheck } from 'lucide-react';
          ...
          <div className="lg:col-span-5">
            <div className="glass-card p-6 sm:p-8 rounded-2xl border border-slate-800 shadow-2xl relative">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-industrial-900/90 p-4 rounded-xl border border-slate-800">
                  <div className="text-2xl sm:text-3xl font-black text-amber-400">1000+</div>
              ...
              <div className="space-y-3 bg-industrial-950/80 p-4 rounded-xl border border-slate-800/80">
                ...
                <div className="flex flex-wrap gap-2 text-xs">
                  <span className="bg-amber-950/80 text-amber-200 border border-amber-800/60 px-2.5 py-1 rounded-md">MS Hex Bolts (M6-M36)</span>
                  <span className="bg-amber-950/80 text-amber-200 border border-amber-800/60 px-2.5 py-1 rounded-md">MS Hex Nuts</span>
